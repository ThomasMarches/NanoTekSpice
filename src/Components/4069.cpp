...
namespace nts
{
    Component4069::Component4069() : AComponent(0)
    {
    ...
    void Component4069::setLink(PinID pin, nts::IComponent& other, PinID otherPin)
    {
    ...
    nts::Tristate Component4069::compute(PinID pin) 
    {
        if (pin == 0 || pin > m_iMaxPins)
